      ...
      <div className="relative aspect-[9/19.5] overflow-hidden rounded-[38px] border border-chrome-hair bg-void p-1 shadow-[0_40px_90px_-34px_rgba(92,238,192,0.35)]">
        <div className="relative h-full w-full overflow-hidden rounded-[32px] bg-void">
          ...
          <div className="border-b border-chrome-hair px-6 pb-5 pt-6">
            ...
            <h3 className="mt-3 font-display text-[24px] font-medium leading-[1.1] text-chrome">
              Epinephrine · Pediatric
            </h3>
            <p className="mt-1 font-sans text-[11px] text-chrome-muted">
              IV · Cardiac arrest
            </p>
          </div>
          ...
          <div className="px-5 pt-4">
            ...
            <div className="mt-3 space-y-2">
              {[
                ...
                <div
                  key={k}
                  className="flex items-center justify-between border-b border-chrome-hair/60 pb-2 font-sans text-[12px]"
                >
                  <span className="text-chrome-muted">{k}</span>
                  <span className="font-medium text-chrome">{v}</span>
                </div>
              ))}
            </div>
